...
$caminhoDosArquivos = [
    ...
    "ViewPainelLadoDireitoTopo"   => $path."public".DIRECTORY_SEPARATOR."View".DIRECTORY_SEPARATOR."ViewPainelLadoDireitoTopo.php",
    "ViewPainelLadoDireitoRodape" => $path."public".DIRECTORY_SEPARATOR."View".DIRECTORY_SEPARATOR."ViewPainelLadoDireitoRodape.php",
